...
public class MainController implements Initializable, BookReturnCallback {
    ...
    private void handleAboutMenu(ActionEvent event) {
        LibraryAssistantUtil.loadWindow(getClass().getResource("/goa/about/about.fxml"), "About Me", null);
    }
    ...
    private void initDrawer() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/goa/tool/toolbar.fxml"));
