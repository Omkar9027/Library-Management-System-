...
import goa.export.ListToPDF;
import goa.book.BookAddController;
import goa.member.MemberAddController;
import goa.main.MainController;
...
public class MemberListController implements Initializable {
    ...
    private void handleMemberEdit(ActionEvent event) {
        ...
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/goa/member/member_add.fxml"));
